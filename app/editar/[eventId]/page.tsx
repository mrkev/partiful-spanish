...
export default function EditarEventPage({ params }: { params: { eventId: string } }) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 to-cyan-100 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-700 mb-4">Evento no encontrado</h1>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Actualiza los detalles de tu evento 📝</p>
          </div>
